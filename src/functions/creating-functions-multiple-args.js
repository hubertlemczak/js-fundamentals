...
//
// TODO: write code below
function loud(string, number) {
  let result = '';
  for (let i = 0; i < number; i++) {
    result += '!';
  }
  return string.toUpperCase() + result;
}
...
module.exports = {
  ...
  b: loud, // change undefined to be the name of the function defined to return the string with exclamations (the second todo)
};
